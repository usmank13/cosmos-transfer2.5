...
"""
torchrun --nproc_per_node=1 --master_port=12341 -m scripts.train --config=cosmos_transfer2/_src/predict2/action/configs/config.py -- experiment=cosmos_predict2p1_2B_reason_embeddings_action_conditioned_rectified_flow_bridge_13frame_480_640_ ~dataloader_train.dataloaders
"""
...
"""
torchrun --nproc_per_node=1 --master_port=12341 -m scripts.train --config=cosmos_transfer2/_src/predict2/action/configs/config.py -- experiment=cosmos_predict2p5_2B_action_conditioned_gr00t_gr1_customized_13frame ~dataloader_train.dataloaders
"""
...
"""
torchrun --nproc_per_node=1 --master_port=12341 -m scripts.train --config=cosmos_transfer2/_src/predict2/action/configs/config.py -- experiment=cosmos_predict2p5_2B_action_conditioned_gr00t_gr1_customized_13frame_full ~dataloader_train.dataloaders
"""
...
"""
torchrun --nproc_per_node=1 --master_port=12341 -m scripts.train --config=cosmos_transfer2/_src/predict2/action/configs/action_conditioned/config.py -- experiment=cosmos_predict2p5_2B_action_conditioned_gr00t_gr1_customized_13frame_full_16nodes_release ~dataloader_train.dataloaders
"""
