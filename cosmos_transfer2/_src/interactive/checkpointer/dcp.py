...
class ModelWrapper(Stateful):
    ...
    def __init__(self, model: Union[nn.Module, List[nn.Module]], load_ema_to_reg: bool = False):
        ...
        if self.load_ema_to_reg:
            from cosmos_transfer2._src.interactive.methods.cosmos2_interactive_model import (
                Cosmos2InteractiveModel as cosmos2_interactive_model,
            )
            from cosmos_transfer2._src.predict2.models.text2world_model import DiffusionModel as predict2_DiffusionModel
