...
class ControlVideo2WorldModel(Video2WorldModel):
    ...
    def add_lora(
        ...
        **kwargs,
        ...
        if not self._lora_ready:
            return  # Called from build_net too early; will be called again from set_up_model
        ...
        log.info(
            ...
            f"target={config.lora_target}, patterns={target_patterns}"
        )
    ...
    def set_up_model(self):
        ...
        if self.config.use_lora:
            ...
            self._inject_lora()
            # freeze_base_model already ran (from __init__) before LoRA was injected,
            # so explicitly unfreeze LoRA params now
